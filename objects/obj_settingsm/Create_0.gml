...
ds_list_add(menu, "EXIT", "Scale", "Opacity", "Coordinates", "Debug", " ", "RESET");	// the menu items, add or remove items to customize
...
// text variables
// title
title_text = "CONTROLS" //"Easy and fast Menu";	// the title of the menu
