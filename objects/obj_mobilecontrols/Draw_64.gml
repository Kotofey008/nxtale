...
txt("Analog Scale", 120.5, 121, fnt_main, fa_left, fa_middle, c_white, text_black_fade)
draw_sprite_ext(spr_pixel, 0, 459.5, 121, 82, 18, 0, c_white, text_black_fade)
txt("Analog Type", 124, 167, fnt_main, fa_left, fa_middle, c_white, text_black_fade)
draw_sprite_ext(spr_pixel, 0, 459.5, 167, 82, 18, 0, c_white, text_black_fade)
txt("Controls Opacity", 106.5, 213, fnt_main, fa_left, fa_middle, c_white, text_black_fade)
draw_sprite_ext(spr_pixel, 0, 459.5, 213, 82, 18, 0, c_white, text_black_fade)
txt("Hide Additionals", 106.5, 259, fnt_main, fa_left, fa_middle, c_white, text_black_fade)
draw_sprite_ext(spr_pixel, 0, 459.5, 259, 82, 18, 0, c_white, text_black_fade)
txt("Reset Config", 241, 412.25, fnt_main, fa_left, fa_middle, c_white, text_black_fade)